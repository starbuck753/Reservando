...
Listado.prototype.buscarRestaurante = function(id) {
    return this.restaurantes.find(restaurant => restaurant.id == id);
}
...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    var ubicacionesFiltradas = ubicaciones.filter(filtrarElementos);
...
Listado.prototype.obtenerRubros = function() {
    ...
    var rubrosFiltrados = rubros.filter(filtrarElementos);
